...
const ProductEdit = (props) => {
  ...
  const getProductById = () => {
    ...
    if (fetchUrlLength === 9) {
      ...
      let categoryFromUrl = document.location.href.split("/")[5];
      let subCategoryFromUrl = document.location.href.split("/")[6];
      let idFromUrl = document.location.href.split("/")[7];
      ...
      axios
        ...
        .then(function (response) {
          if (response.data.msg === "FilterProductGETREQUEST") {
            ...
            setproductId(response.data.fetchProduct[0].id);
            setproductName(response.data.fetchProduct[0].name);
            setproductMrp(response.data.fetchProduct[0].mrp);
            setproductDiscount(response.data.fetchProduct[0].discountPercent);
            setproductType(response.data.fetchProduct[0].productType);
            setproductCategory(response.data.fetchProduct[0].Category);
            setproductSubCategoryData(
              response.data.fetchProduct[0].subCategory
            );
            setproductTaxType(response.data.fetchProduct[0].taxStatus);
            setproductTaxClassData(response.data.fetchProduct[0].taxClass);

            setproductShippingStatus(
              response.data.fetchProduct[0].shippingStatus
            );
            setproductUnits(response.data.fetchProduct[0].totalUnits);
            setproductStockStatus(response.data.fetchProduct[0].stockStatus);
            setproductTrackQty(response.data.fetchProduct[0].trackQty);
            setproductImageLink1(response.data.fetchProduct[0].image1);
            setproductImageLink2(response.data.fetchProduct[0].image2);
            setproductImageLink3(response.data.fetchProduct[0].image3);
            setproductImageLink4(response.data.fetchProduct[0].image4);
            setproductImageLink5(response.data.fetchProduct[0].image5);
            setproductDescription(
              response.data.fetchProduct[0].productDescription
            );
  ...
  const UpdateProductOnSubmit = (e) => {
    ...
    // console.log("-------------- UpdateProductOnSubmit btn clicked --------")
    ...
    let sessionUrl = props.APIS.updateProduct + productId + "/";
    ...
    axios
      ...
      .then(function (response) {
        ...
        if (response.data.msg === "ProductUpdatedSuccessfully") {
          alert("ProductUpdatedSuccessfully");
  ...
  return (
    <>
      <div className="tabAddProduct">
        ...
        <form method="POST" onSubmit={UpdateProductOnSubmit}>
